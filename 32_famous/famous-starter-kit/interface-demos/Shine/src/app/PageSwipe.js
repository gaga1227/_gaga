define(function(require, exports, module) {
    ...
    function PageSwipe(options) {
        ...
        this.sync = new GenericSync(['mouse', 'touch'], {direction : this.options.direction});
    ...
    function _checkPage() {
        ...
        if (this._particle.getPosition()[0] > this.size * this.index + (0.5 * this.size)) _nextPage.call(this);
        if (this._particle.getPosition()[0] < this.size * this.index - (0.5 * this.size)) _previousPage.call(this);
        if (!this._hasSpringAttached) _attachSpring.call(this);
