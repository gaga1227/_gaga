define(function(require, exports, module) {
    ...
    function _createIcons() {
        ...
        var equalsIcon = new Surface({
            size: [40, 40],
            content: '<img height=40px width=40px src="img/bottomIcons/equals-icon.png"/>'
        });
        ...
        var middleIcon = new Surface({
            size: [100, 100],
            content: '<img height=100px width=100px src="img/bottomIcons/camera-icon.png"/>'
        });
        ...
        var nextIcon = new Surface({
            size: [40, 40],
            content: '<img height=40px width=40px src="img/bottomIcons/next-icon.png"/>'
        });
